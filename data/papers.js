window.RESEARCH_PAPER_FEED = {
  "updatedAt": "2026-07-17T07:35:25.637513+00:00",
  "daysBack": 14,
  "minPerModule": 5,
  "maxPerModule": 10,
  "status": "ok",
      ...
      "papers": [
        {
          ...
          "mainConclusion": "The strong dependence of the vacancy diffusion coefficient on the average defect concentration provides new insights into the origin of memristive behavior observed in MoS$_2$.",
          "articleSummaryZh": "该论文围绕“Self-organized defect clustering and concentration-dependent vacancy diffusion in MoS$_2$”展开，关注机器学习原子间势。作者利用分子动力学或有限温度模拟检验体系行为，用于理解相关体系的结构、动力学或物性响应。",
      ...
      "papers": [
        {
          ...
          "mainConclusion": "As a result, bilayer ReIrGe2Se6 enables switching between an anomalous valley Hall effect and a layer-locked anomalous valley Hall effect, providing nonvolatile control of layer, valley, and spin-resolved transport responses.",
          "articleSummaryZh": "该论文围绕“Multistate ferroelectricity and switchable layer-locked anomalous valley Hall effects in bilayer ReIrGe2Se6”展开，关注多铁性、多铁材料、磁电耦合、铁电性。作者结合第一性原理或电子结构计算开展分析，用于理解相关体系的结构、动力学或物性响应。",
          "discussionFocusZh": "讨论重点是多铁性、多铁材料、磁电耦合、铁电性，以及这些概念如何影响模型精度、材料性质或物理机制解释。",
          "mainConclusionZh": "主要结论需要结合原文摘要和正文进一步确认；从当前元数据看，该工作给出了与上述关键词直接相关的方法、基准或物性结果。"
        },
        {
          "source": "arXiv",
          ...
          "mainConclusion": "We find that the integer quantum Hall-chiral spin liquid interface hosts a spinless charged excitation that is bound to the interface.",
          "articleSummaryZh": "该论文围绕“Spinless charged excitation at the interface between a conventional topological insulator and a topological Mott insulator”展开，关注Hubbard 模型、Mott 绝缘体。作者基于摘要中的模型、计算或实验结果展开研究，用于理解相关体系的结构、动力学或物性响应。",
        ...
        },
        {
          ...
          "articleSummary": "Quantum many-body scars provide an exception to generic thermalising dynamics, but their relation to integrability remains unclear. Here we apply the periodic-orbit framework to the integrable XYZ/XXZ spin-1/2 chain, developing an energy-resolved approach that enables us to locate and track periodic orbits across the spectrum.",
          ...
          "mainConclusion": "We further show that this structure persists upon breaking integrability with a transverse field, with the periodic orbits continuing to govern the dynamics.",
          "articleSummaryZh": "该论文围绕“Periodic orbits and quantum many-body scars in integrable spin chains”展开，关注量子多体。作者提出并验证新的模型、方法或工作流，用于理解相关体系的结构、动力学或物性响应。",
        ...
        },
        {
          ...
          "articleSummary": "The current leading approach to the variational optimization of projected entangled-pair states (PEPS) is based on automatic differentiation, which allows for a convenient evaluation of the energy gradient with respect to the local variational degrees of freedom. However, evaluating the energy gradient not only remains a major computational bottleneck of the optimization procedure, but also suffers from frequent numerical instabilities.",
          ...
          "mainConclusion": "Finally, we demonstrate how this approach drastically simplifies the practical implementation of stable gradient-based PEPS optimization.",
          "articleSummaryZh": "该论文围绕“Implicit differentiation of tensor network algorithms”展开，关注张量网络。作者基于摘要中的模型、计算或实验结果展开研究，用于理解相关体系的结构、动力学或物性响应。",
          "discussionFocusZh": "讨论重点是张量网络，以及这些概念如何影响模型精度、材料性质或物理机制解释。",
          "mainConclusionZh": "主要结论需要结合原文摘要和正文进一步确认；从当前元数据看，该工作给出了与上述关键词直接相关的方法、基准或物性结果。"
        },
        {
          "source": "arXiv",
          ...
          "published": "2026-07-16T11:46:06Z",
          "updated": "2026-07-16T11:46:06Z",
          "url": "https://arxiv.org/abs/2607.14875v1",
          "pdfUrl": "https://arxiv.org/pdf/2607.14875v1",
          "doi": "",
          "venue": "cond-mat.str-el, cond-mat.dis-nn, physics.comp-ph",
          "keywords": [
            "strongly correlated systems",
            "strongly correlated electrons",
            "Hubbard model",
          ...
          "articleSummary": "Building on the multi-determinant Transformer backflow neural quantum state (NQS) ansatz and the associated multi-stage training workflow for the doped two-dimensional Hubbard model, we investigate how the optimization dynamics of the NQS depend on several key optimization and architectural hyperparameters. The workflow consists of neural-network backflow (NNB) initialization, supervised Transformer pre-training, and main energy optimization using the Moment-Adaptive ReConfiguration Heuristic (MARCH) within variational Monte Carlo.",
          "discussionFocus": "重点围绕 Hubbard model 展开。 Building on the multi-determinant Transformer backflow neural quantum state (NQS) ansatz and the associated multi-stage training workflow for the doped two-dimensional Hubbard model, we investigate how the optimization dynamics of the NQS depend on several key optimization and architectural hyperparameters.",
          "mainConclusion": "We find that a moderate update constraint improves the efficiency of MARCH optimization, larger Transformer width and more determinant channels improve the expressive capacity of the ansatz, and larger Monte Carlo batches reduce sampling noise in the update direction.",
          "articleSummaryZh": "该论文围绕“Optimization dynamics of Transformer backflow neural quantum states for the two-dimensional Hubbard model”展开，关注Hubbard 模型。作者基于摘要中的模型、计算或实验结果展开研究，用于理解相关体系的结构、动力学或物性响应。",
          "discussionFocusZh": "讨论重点是Hubbard 模型，以及这些概念如何影响模型精度、材料性质或物理机制解释。",
          "mainConclusionZh": "主要结论需要结合原文摘要和正文进一步确认；从当前元数据看，该工作给出了与上述关键词直接相关的方法、基准或物性结果。"
        },
        {
          "source": "arXiv",
          ...
          "published": "2026-07-16T07:40:15Z",
          "updated": "2026-07-16T07:40:15Z",
          "url": "https://arxiv.org/abs/2607.14677v1",
          "pdfUrl": "https://arxiv.org/pdf/2607.14677v1",
          "doi": "",
          ...
          "keywordMatches": 1,
          "matchReasons": [
            "标题匹配 unconventional superconductivity",
            "最近 3 天发布"
          ],
          "articleSummary": "Superconducting (SC) pairing mechanism, origin of high $T_c$ and symmetry of SC order parameter in Fe-based superconductors are among the important unsolved problems in condensed matter and materials physics. We study the SC properties of ThFeAsN, a Fe-based high $T_c$ superconductor, by {\\it ab initio} superconducting density functional theory calculations with electron-phonon coupling, screened static and dynamic electron-electron Coulomb repulsion and spin fluctuation (SF) mediated pair-interaction fully taken into account.",
          "discussionFocus": "重点围绕 unconventional superconductivity 展开。 We also present distinct SC properties such as quasiparticle density of states and ultrasonic attenuation coefficient which can be immediately verified by experiments.",
          "mainConclusion": "Our calculations reveal that ThFeAsN is a SF-mediated multiband superconductor with the calculated $T_c$ of 22.4 K and the $d_{xy}$-wave SC order parameter with different signs on different Fermi surface sheets, in consistent with experiments.",
          "articleSummaryZh": "该论文围绕“Spin fluctuation-mediated unconventional superconductivity in ThFeAsN from first-principles”展开，关注非常规超导。作者结合第一性原理或电子结构计算开展分析，用于理解相关体系的结构、动力学或物性响应。",
          "discussionFocusZh": "讨论重点是非常规超导，以及这些概念如何影响模型精度、材料性质或物理机制解释。",
          "mainConclusionZh": "主要结论需要结合原文摘要和正文进一步确认；从当前元数据看，该工作给出了与上述关键词直接相关的方法、基准或物性结果。"
        },
        {
          "source": "arXiv",
          "query": "凝聚态物理强关联体系和多铁性质",
          "title": "Magnetic Order in bilayer Ruddlesden-Popper Nickelates",
          "authors": [
            "Yiming Wang",
            "Guijing Duan",
            "Zhiguang Liao",
          ...
          "published": "2026-07-16T17:31:14Z",
          "updated": "2026-07-16T17:31:14Z",
          "url": "https://arxiv.org/abs/2607.15228v1",
          "pdfUrl": "https://arxiv.org/pdf/2607.15228v1",
          "doi": "",
          "venue": "cond-mat.supr-con, cond-mat.mtrl-sci, cond-mat.str-el",
          "keywords": [
            "strongly correlated systems",
          ...
          "keywordMatches": 2,
          "matchReasons": [
            "摘要匹配 unconventional superconductivity",
            "摘要匹配 high-temperature superconductivity",
            "最近 3 天发布"
          ],
          "articleSummary": "The recent discovery of high-temperature superconductivity in the bilayer nickelate La$_3$Ni$_2$O$_7$ has led to extensive interest in the correlation physics of its normal state. Given that the superconducitivity develops near a density wave order in the phase diagram, it is important to elucidate the nature of this order.",
          "discussionFocus": "重点围绕 unconventional superconductivity、high-temperature superconductivity 展开。 Given that the superconducitivity develops near a density wave order in the phase diagram, it is important to elucidate the nature of this order.",
          "mainConclusion": "Our results are consistent with the rapidly emerging experiments about the magnetic correlations in the density wave order of the bilayer nickelate.",
          "articleSummaryZh": "该论文围绕“Magnetic Order in bilayer Ruddlesden-Popper Nickelates”展开，关注非常规超导、高温超导。作者提出并验证新的模型、方法或工作流，用于理解相关体系的结构、动力学或物性响应。",
          "discussionFocusZh": "讨论重点是非常规超导、高温超导，以及这些概念如何影响模型精度、材料性质或物理机制解释。",
          "mainConclusionZh": "主要结论需要结合原文摘要和正文进一步确认；从当前元数据看，该工作给出了与上述关键词直接相关的方法、基准或物性结果。"
        },
        {
          "source": "arXiv",
          "query": "凝聚态物理强关联体系和多铁性质",
          "title": "Quantum many-body mixed phase space revealed by hybrid feedback control",
          "authors": [
            "Hang Dong",
            "Jie Ren",
            "Andrew Hallam",
          ...
          "url": "https://arxiv.org/abs/2607.14223v1",
          "pdfUrl": "https://arxiv.org/pdf/2607.14223v1",
          "doi": "",
          "venue": "quant-ph, cond-mat.stat-mech, cond-mat.str-el",
          "keywords": [
            "strongly correlated systems",
          ...
          "articleSummary": "Understanding how complex systems transition between order and chaos is a central challenge of nonequilibrium physics. While weak perturbations of classical integrable systems give rise to a mixed phase space of coexisting regular and chaotic trajectories, analogous behavior in interacting quantum many-body systems has remained elusive.",
          "discussionFocus": "重点围绕 quantum many-body 展开。 Here we develop and experimentally implement a hybrid quantum-classical feedback protocol that autonomously discovers and stabilizes long-lived regular trajectories in a superconducting quantum processor.",
          "mainConclusion": "The stabilized trajectories reveal a quantum many-body mixed phase space emerging from nonlinear variational dynamics, without a direct analogue in classical or few-body quantum systems.",
          "articleSummaryZh": "该论文围绕“Quantum many-body mixed phase space revealed by hybrid feedback control”展开，关注量子多体。作者提出并验证新的模型、方法或工作流，用于理解相关体系的结构、动力学或物性响应。",
          "discussionFocusZh": "讨论重点是量子多体，以及这些概念如何影响模型精度、材料性质或物理机制解释。",
          "mainConclusionZh": "主要结论需要结合原文摘要和正文进一步确认；从当前元数据看，该工作给出了与上述关键词直接相关的方法、基准或物性结果。"
        },
        {
          ...
          "articleSummary": "Fractional quantum multiferroics, arising from the coupling between fractional quantum ferroelectricity (FQFE) and altermagnetism (AM), provide a promising platform for nonvolatile control of momentum dependent spin splitting in systems with zero net magnetization. However, extending this FQFE-AM coupling to valley degrees of freedom and Berry curvature driven valley Hall effects remains largely unexplored.",
          "discussionFocus": "重点围绕 multiferroic、ferroelectricity 展开。 However, extending this FQFE-AM coupling to valley degrees of freedom and Berry curvature driven valley Hall effects remains largely unexplored.",
          "mainConclusion": "Here, using first-principles calculations, we demonstrate that monolayer Cr2S2 realizes a two dimensional FQFE-AM platform with two switchable FQFE states connected by composite symmetry operations combining a fractional lattice translation with time reversal or parity-time reversal.",
          "articleSummaryZh": "该论文围绕“Fractional quantum ferroelectric control of spin-valley locking and valley Hall effects in altermagnetic monolayer Cr2S2”展开，关注多铁性、铁电性。作者结合第一性原理或电子结构计算开展分析，用于理解相关体系的结构、动力学或物性响应。",
          "discussionFocusZh": "讨论重点是多铁性、铁电性，以及这些概念如何影响模型精度、材料性质或物理机制解释。",
          "mainConclusionZh": "主要结论需要结合原文摘要和正文进一步确认；从当前元数据看，该工作给出了与上述关键词直接相关的方法、基准或物性结果。"
        },
        {
          "source": "arXiv",
          ...
          "articleSummary": "Altermagnets combine compensated collinear magnetic order with momentum-dependent spin splitting, offering a promising platform for coupling spin and valley degrees of freedom with ferroelectricity and Berry-curvature driven transport in the absence of net magnetization. However, achieving nonvolatile and selective control of these intertwined degrees of freedom remains a key challenge.",
          "discussionFocus": "重点围绕 magnetoelectric coupling、ferroelectricity 展开。 However, achieving nonvolatile and selective control of these intertwined degrees of freedom remains a key challenge.",
          "mainConclusion": "Here, using first-principles calculations, we show that the direction of interlayer sliding serves as a symmetry selective control parameter in altermagnetic bilayer Fe2WS4.",
          "articleSummaryZh": "该论文围绕“Interlayer sliding direction as a symmetry selector in altermagnetic bilayer Fe2WS4: Switchable anomalous Hall and anomalous valley Hall effects”展开，关注磁电耦合、铁电性。作者结合第一性原理或电子结构计算开展分析，用于理解相关体系的结构、动力学或物性响应。",
          "discussionFocusZh": "讨论重点是磁电耦合、铁电性，以及这些概念如何影响模型精度、材料性质或物理机制解释。",
          "mainConclusionZh": "主要结论需要结合原文摘要和正文进一步确认；从当前元数据看，该工作给出了与上述关键词直接相关的方法、基准或物性结果。"
        }
      ]
    }
