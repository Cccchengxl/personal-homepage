window.RESEARCH_PAPER_FEED = {
  "updatedAt": "2026-07-17T10:14:24.547284+00:00",
  "daysBack": 14,
  "minPerModule": 5,
  "maxPerModule": 10,
  "status": "ok",
    ...
    },
    {
      ...
      "papers": [
        ...
        },
        {
          ...
          "discussionFocusZh": "我们进一步通过分析确定相边界并构建相应的拓扑相图，建立了一种无需批量自旋分裂即可实现高阶拓扑的稳健路线。通过引入在顶层和底层具有相反符号的层解析面外$d$波交变磁项，系统保留了$\\mathcal{PT}$对称性并保持体能带中的自旋简并性，同时使螺旋边缘态产生间隙并生成局部角态。 结合关键词看，阅读时应重点关注交变磁性相关的交变磁性的对称性来源、动量空间自旋劈裂，以及这些特征如何影响输运、光学或磁动力学响应。",
        ...
        },
        {
          ...
          "discussionFocusZh": "在这里，我们展示了分子束外延生长并研究了直接沉积在 GaAs(111)B 上的近相纯纤锌矿 MnTe 的特性，并表明生长条件的微小变化强烈改变了相组成，从嵌入纤锌矿 MnTe 基体中的内轴 NiAs 型夹杂物的多相状态到几乎单相极性纤锌矿层。 MnTe 是这方面的关键材料，但实验研究主要集中在稳定的 NiAs 型多晶型物上，而极性纤锌矿相仍未得到探索。 结合关键词看，阅读时应重点关注铁磁性、交变磁性相关的交变磁性的对称性来源、动量空间自旋劈裂，以及这些特征如何影响输运、光学或磁动力学响应。",
