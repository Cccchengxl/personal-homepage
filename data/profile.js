window.SITE_PROFILE = {
  ...
  "about": "我在上海大学获得理学博士学位，现任材料助理研究员。我正在关注机器学习势函数和分子动力学模拟在热力学性质、相变、自由能与热输运计算中的可靠性和可迁移性。我也关注凝聚态强关联体系、交变磁性和多铁材料中电子关联、磁电耦合与自旋-晶格耦合对宏观物性的影响。",
  ...
  "researchAreas": [
    ...
    },
    {
      ...
      "description": "强关联电子体系、多铁材料、交变磁性、铁电性、铁磁性、磁电耦合和量子多体物理。",
      "keywords": [
  ...
  "paperFeed": {
    ...
    "topJournalFeed": {
      ...
      "queryText": "machine learning molecular dynamics interatomic potential thermodynamic DeepMD MACE strongly correlated electrons Mott Hubbard quantum spin liquid multiferroic ferroelectric magnetoelectric altermagnetism altermagnetic"
    }
  },
  "position": "材料助理研究员",
  "education": "上海大学理学博士",
